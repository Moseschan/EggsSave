...
{
    NSLog(@"section = %ld,sections = %ld, expand.sections = %lu, and sum = %lu", (long)section,[_SKSTableViewDelegate tableView:tableView numberOfRowsInSection:section],(unsigned long)[[[self expandedIndexPaths] objectAtIndex:section] count],[_SKSTableViewDelegate tableView:tableView numberOfRowsInSection:section] + [[[self expandedIndexPaths] objectAtIndex:section] count]);
...
- (nullable NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section
{
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:titleForHeaderInSection:)]) {
        return [_SKSTableViewDelegate tableView:(SKSTableView *)tableView titleForHeaderInSection:section];
    }
...
- (CGFloat)tableView:(UITableView *)tableView estimatedHeightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:estimatedHeightForRowAtIndexPath:)]) {
        return [_SKSTableViewDelegate tableView:tableView estimatedHeightForRowAtIndexPath:indexPath];
    }
